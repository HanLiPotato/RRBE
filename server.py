...
from RRBE_CS import serverEmbedding
...
class FtpServerProtocol(threading.Thread):
    ...
    def PASS(self, passwd):
        print('PASS:', passwd, '\n')
        sql = "select password from users where username = '" + self.username + "'"
        cursor.execute(sql)
    ...
    def STOR(self, filename):
        ...
        serverEmbedding.embeddingA(pathname)
