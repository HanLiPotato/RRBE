...
class Ui_LoginDialog(object):
    def setupUi(self, LoginDialog):
        ...
        self.visitorRadio.setGeometry(QtCore.QRect(100, 130, 91, 19))
    ...
    def retranslateUi(self, LoginDialog):
        ...
        self.registerRadio.setText(_translate("LoginDialog", "Login"))
        self.visitorRadio.setText(_translate("LoginDialog", "Register"))
